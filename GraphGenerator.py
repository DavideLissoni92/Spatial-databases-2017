...
#reset views in the case that the algorithm has already been run 
cursor.execute("DROP VIEW IF EXISTS distanza_collegamenti_camere")
cursor.execute("DROP VIEW IF EXISTS distanza_collegamenti_corridoio")
cursor.execute("DROP VIEW IF EXISTS distanza_corridoio")
cursor.execute("DROP VIEW IF EXISTS recreation_corridoio")
cursor.execute("DROP VIEW IF EXISTS collegamenti_corridoio_completo_con_distanza")
cursor.execute("DROP VIEW IF EXISTS collegamenti_corridoio_sulla_stessa_riga_con_distanza")
cursor.execute("DROP VIEW IF EXISTS collegamenti_corridoio_su_righe_diverse_con_distanza")
cursor.execute("DROP VIEW IF EXISTS collegamenti_corridoio_sulla_stessa_riga")
cursor.execute("DROP VIEW IF EXISTS endpoint_stanze_e_corridoio")
cursor.execute("DROP VIEW IF EXISTS corridoio_single_line")
cursor.execute("DROP VIEW IF EXISTS medial_axis_corridoio")
cursor.execute("DROP VIEW IF EXISTS collegamenti_stanze_corridoio")
cursor.execute("DROP VIEW IF EXISTS corridoio_collegamenti")
cursor.execute("DROP VIEW IF EXISTS collegamenti")
cursor.execute("DROP VIEW IF EXISTS vicini_tra_stanze")
cursor.execute("DROP VIEW IF EXISTS primo_piano_medial_axis")
cursor.execute("DROP VIEW IF EXISTS primo_piano_stanze_centroidi")
cursor.execute("DROP VIEW IF EXISTS primo_piano_stanze")
...
toatalPath=path+nameShape

shapefile = osgeo.ogr.Open(toatalPath)
...
#create and get polygons of the rooms
